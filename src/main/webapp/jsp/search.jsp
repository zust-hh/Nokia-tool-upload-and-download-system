	...
	<div class="loginBox">
		...
		<form class="uk-form">
			...
			<div class="uk-form-row">
		        <center><input id="username" class="uk-width-2-3 uk-form-large" type="text" placeholder="用户名"></center>
		    </div>
		    <div class="uk-form-row" style="margin:0 !important;">
				<center><input id="password" class="uk-width-2-3 uk-form-large" type="password" placeholder="密码"></center>
		    </div>
		    <div class="uk-form-row">
